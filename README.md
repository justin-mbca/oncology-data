## Detailed Data Normalization & Quality Examples

### dbt Model Example (`transforms/dbt_project/models/gold/variants.sql`)
```sql
...
### Great Expectations Suite Example (`transforms/dbt_project/models/schema.yaml`)
```yaml
version: 2
models:
	- name: variants
...
These examples show how dbt is used to define and materialize normalized tables, and how Great Expectations (via YAML) is used to enforce data quality constraints like not-null and uniqueness.
